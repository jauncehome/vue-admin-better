 ...
 */
"use strict";
(self["webpackChunkvue_admin_better"] = self["webpackChunkvue_admin_better"] || []).push([["5942"], {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".content[data-v-6b3ed222]{position:relative;display:flex;align-items:center;justify-content:center;width:100%;background:#000}.content .g-number[data-v-6b3ed222]{position:absolute;top:27%;z-index:99;width:300px;font-size:32px;color:#fff;text-align:center}.content .g-container[data-v-6b3ed222]{position:relative;width:300px;height:400px;margin:auto}.content .g-contrast[data-v-6b3ed222]{width:300px;height:400px;overflow:hidden;background-color:#000;filter:contrast(15) hue-rotate(0);animation:hueRotate-data-v-6b3ed222 10s infinite linear}.content .g-circle[data-v-6b3ed222]{position:relative;box-sizing:border-box;width:300px;height:300px;filter:blur(8px)}.content .g-circle[data-v-6b3ed222]::after{position:absolute;top:40%;left:50%;width:200px;height:200px;content:\"\";background-color:#00ff6f;border-radius:42% 38% 62% 49%/45%;transform:translate(-50%, -50%) rotate(0);animation:rotate-data-v-6b3ed222 10s infinite linear}.content .g-circle[data-v-6b3ed222]::before{position:absolute;top:40%;left:50%;z-index:99;width:176px;height:176px;content:\"\";background-color:#000;border-radius:50%;transform:translate(-50%, -50%)}.content .g-bubbles[data-v-6b3ed222]{position:absolute;bottom:0;left:50%;width:100px;height:40px;background-color:#00ff6f;filter:blur(5px);border-radius:100px 100px 0 0;transform:translate(-50%, 0)}.content li[data-v-6b3ed222]{position:absolute;background:#00ff6f;border-radius:50%}.content li[data-v-6b3ed222]:nth-child(0){top:50%;left:72px;width:17px;height:17px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 9s ease-in-out -0.389s infinite}.content li[data-v-6b3ed222]:nth-child(1){top:50%;left:16px;width:23px;height:23px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 7s ease-in-out -2.308s infinite}.content li[data-v-6b3ed222]:nth-child(2){top:50%;left:50px;width:20px;height:20px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 4s ease-in-out -3.497s infinite}.content li[data-v-6b3ed222]:nth-child(3){top:50%;left:53px;width:30px;height:30px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 9s ease-in-out -2.022s infinite}.content li[data-v-6b3ed222]:nth-child(4){top:50%;left:40px;width:20px;height:20px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 6s ease-in-out -2.584s infinite}.content li[data-v-6b3ed222]:nth-child(5){top:50%;left:43px;width:22px;height:22px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 5s ease-in-out -0.53s infinite}.content li[data-v-6b3ed222]:nth-child(6){top:50%;left:76px;width:27px;height:27px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 6s ease-in-out -3.143s infinite}.content li[data-v-6b3ed222]:nth-child(7){top:50%;left:72px;width:27px;height:27px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 4s ease-in-out -1.651s infinite}.content li[data-v-6b3ed222]:nth-child(8){top:50%;left:72px;width:19px;height:19px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 5s ease-in-out -1.732s infinite}.content li[data-v-6b3ed222]:nth-child(9){top:50%;left:20px;width:24px;height:24px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 4s ease-in-out -0.776s infinite}.content li[data-v-6b3ed222]:nth-child(10){top:50%;left:30px;width:19px;height:19px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 8s ease-in-out -4.986s infinite}.content li[data-v-6b3ed222]:nth-child(11){top:50%;left:60px;width:28px;height:28px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 6s ease-in-out -0.913s infinite}.content li[data-v-6b3ed222]:nth-child(12){top:50%;left:59px;width:18px;height:18px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 9s ease-in-out -4.362s infinite}.content li[data-v-6b3ed222]:nth-child(13){top:50%;left:56px;width:24px;height:24px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 7s ease-in-out -3.865s infinite}.content li[data-v-6b3ed222]:nth-child(14){top:50%;left:57px;width:23px;height:23px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 4s ease-in-out -2.792s infinite}.content li[data-v-6b3ed222]:nth-child(15){top:50%;left:33px;width:17px;height:17px;transform:translate(-50%, -50%);animation:moveToTop-data-v-6b3ed222 8s ease-in-out -2.744s infinite}@keyframes rotate-data-v-6b3ed222{50%{border-radius:45%/42% 38% 58% 49%}100%{transform:translate(-50%, -50%) rotate(720deg)}}@keyframes moveToTop-data-v-6b3ed222{90%{opacity:1}100%{opacity:.1;transform:translate(-50%, -180px)}}@keyframes hueRotate-data-v-6b3ed222{100%{filter:contrast(15) hue-rotate(360deg)}}", ""]);
// Exports
/* export default */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);


}),
14293: (function (__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
__webpack_require__.r(__webpack_exports__);
...
var VabChargevue_type_style_index_0_id_6b3ed222_lang_scss_scoped_true_ = __webpack_require__(17206);
